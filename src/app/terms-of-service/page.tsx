    ...
    <div className="container mx-auto max-w-3xl py-12 px-4">
      <Card className="glassmorphism">
        ...
        <CardContent className="prose prose-invert max-w-none text-foreground/80 space-y-4">
            ...
            <h3 className="font-headline text-xl text-foreground">1. The Service</h3>
            <p>
            ...
            <h3 className="font-headline text-xl text-foreground">3. Email Communications</h3>
            <p>
            ...
            <h3 className="font-headline text-xl text-foreground">4. Third-Party Advertisements</h3>
            <p>
            ...
            <h3 className="font-headline text-xl text-foreground">5. Disclaimers and Limitation of Liability</h3>
            <p>
